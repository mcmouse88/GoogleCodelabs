package com.mcmouse88.common.connection
...
import com.mcmouse88.common.connection.MusicServiceConnection.MediaBrowserConnectionCallback
...
class MusicServiceConnection(
    ...
    fun sendCommand(command: String, parameters: Bundle?): Boolean {
        return sendCommand(command, parameters) {_, _ ->}
    }
    ...
    private inner class MediaBrowserConnectionCallback(
        ...
        /**
         * Invoked when the client is disconnected from media browser.
         */
