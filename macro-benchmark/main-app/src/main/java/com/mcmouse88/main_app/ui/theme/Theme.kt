package com.mcmouse88.main_app.ui.theme
...
/**
 * BenchMark custom Color Palette
 */
@Stable
class CustomColors(
...
fun ProvideCustomColors(
    ...
    CompositionLocalProvider(value = LocalCustomColors provides colorPalette, content = content)
}

private val LocalCustomColors = staticCompositionLocalOf<CustomColors> {
    error("No Custom Color Palette provides")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [BenchMarkTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
