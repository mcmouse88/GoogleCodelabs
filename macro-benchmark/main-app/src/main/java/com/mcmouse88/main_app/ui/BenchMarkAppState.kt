...
/**
 * Destinations used in the [BenchMarkMain]
 */
...
/**
 * Remembers and creates an instance of [BenchMarkAppState]
 */
@Composable
fun rememberBenchMarkAppState(
    ...
    return remember(scaffoldState, navController, snackbarManager, resources, coroutineScope) {
        BenchMarkAppState(scaffoldState, navController, snackbarManager, resources, coroutineScope)
    }
}

/**
 * Responsible for holding state related to [BenchMarkMain] and containing UI-related logic.
 */
@Stable
class BenchMarkAppState(
