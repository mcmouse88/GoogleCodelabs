package com.mcmouse88.jetpack_compose_basic
...
import com.mcmouse88.jetpack_compose_basic.ui.theme.JetpackComposeBasic
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            JetpackComposeBasic {
                MyGreeting(modifier = Modifier.fillMaxSize())
            }
        }
    }
}
